...
const useStyles = makeStyles((theme) => ({
  ...
  tab: {
    backgroundColor: theme.palette.options,  //DARK MODE TRX SISTEMAS//
    borderRadius: 4,
    width: "100%",
    "& .MuiTab-wrapper": {
      color: theme.palette.fontecor,
    },   //DARK MODE TRX SISTEMAS//
    ...
    <>
      <Grid spacing={3} container>
        ...
        <Grid xs={12} sm={12} md={12} item>
          <FormControl className={classes.selectContainer}>
            ...
            >
              ...
              <MenuItem value={"queue"}>Colas</MenuItem>
       ...
       <Grid xs={12} sm={12} md={12} item>
        ...
        <Grid xs={12} sm={12} md={12} item>
          <FormControl className={classes.selectContainer}>
            <InputLabel id="sendGreetingAccepted-label">Enviar saludo al aceptar conversación</InputLabel>
            <Select
        ...
        <Grid xs={12} sm={12} md={12} item>
          <FormControl className={classes.selectContainer}>
            <InputLabel id="sendGreetingMessageOneQueues-label">Enviar saludo cuando solo haya 1 cola</InputLabel>
            <Select
