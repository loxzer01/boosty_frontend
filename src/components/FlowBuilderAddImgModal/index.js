...
const FlowBuilderAddImgModal = ({ open, onSave, onUpdate, data, close }) => {
  ...
  const handleChangeMedias = e => {
    if (!e.target.files && e.dataTransfer.files && e.dataTransfer.files[0]) {
      return;
    }
        ...
        <Stack>
          <DialogContent dividers>
            <Stack gap={"16px"}>
              ...
              {!loading && open !== "edit" && !dragActive && (
                <Button variant="contained" component="label">
                  Escolha uma imagem e solte aqui
                  <input
                    type="file"
              ...
              {dragActive && (
                <div
                  style={{ width: '552px', color: '#ffffff' }}
