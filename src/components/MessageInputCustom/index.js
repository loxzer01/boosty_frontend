...
const useStyles = makeStyles((theme) => ({
  mainWrapper: {
    backgroundColor: theme.palette.bordabox, //DARK MODE TRX SISTEMAS//
    display: "flex",
  ...
  newMessageBox: {
    backgroundColor: theme.palette.newmessagebox, //DARK MODE TRX SISTEMAS//
    width: "100%",
    display: "flex",
    padding: "7px",
    alignItems: "center",
  ...
  messageInputWrapper: {
    padding: 6,
    marginRight: 7,
    backgroundColor: theme.palette.inputdigita, //DARK MODE TRX SISTEMAS//
    display: "flex",
    borderRadius: 20,
    flex: 1,
  },
