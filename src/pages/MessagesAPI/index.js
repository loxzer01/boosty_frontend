  ...
  return (
    ...
    >
      ...
      <Typography className={classes.elementMargin} component="div">
        ...
        <ul>
          <li>Antes de enviar mensajes, es necesario registrar el token vinculado a la conexión que enviará los mensajes. <br />Para realizar el registro, accede al menú "Conexiones", haz clic en el botón de editar de la conexión y inserta el token en el campo correspondiente.</li>
          <li>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>Body: </b> {"{ \"number\": \"52123456789\", \"body\": \"Tu mensaje\" }"}
          </Typography>
        </Grid>
        <Grid item xs={12} sm={6}>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            <p>A continuación se muestra la lista de información necesaria para el envío de mensajes de imagen:</p>
            <b>Endpoint: </b> {getEndpoint()} <br />
            <b>Método: </b> POST <br />
